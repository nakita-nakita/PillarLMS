...
const RenderSiteSideMenuSelection = ({ site, onComponentSelect }) => {
  ...
  return (
    <ListItem
      ...
      sx={{
        backgroundColor: normalSectionBuiltInSelected.id !== site.id ? theme.palette.grey[200] : theme.palette.primary.dark,
        color: normalSectionBuiltInSelected.id !== site.id ? theme.palette.grey[800] : theme.palette.primary.contrastText,
        "&:hover": {
          color: normalSectionBuiltInSelected.id !== site.id ? theme.palette.grey[800] : theme.palette.primary.contrastText,
          backgroundColor: normalSectionBuiltInSelected.id !== site.id ? theme.palette.grey[300] : theme.palette.primary.dark,
        }
      }}
    >
      {/* <ListItemIcon>
