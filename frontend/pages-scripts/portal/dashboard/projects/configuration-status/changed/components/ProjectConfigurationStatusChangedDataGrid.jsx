...
export default function ProjectConfigurationStatusChangedDataGrid() {
  ...
  const columns = [
    {
      ...
      renderCell: (params) => {
        ...
        return (
          <>
            <p onClick={() => navigate(`/portal/dashboard/project/42/configuration-status/changed/${params.row.id}`)}
              style={{
      ...
      renderCell: (params) => (
        <div>
          ...
          <Menu
            ...
            onClose={handleClose}
          >
            <MenuItem onClick={handleClose}>View Feature</MenuItem>
