...
describe("test backendSiteDesignerSetting_updateAccess.sql.js", () => {
  ...
  test("setList: first time.", async () => {
    ...
    const setList = await updateAccessSql.setList([
      {
  ...
  test("setList & getAll: can update and get record.", async () => {
    ...
    const getAll = await updateAccessSql.getAll()
    ...
    const getAll2 = await updateAccessSql.getAll()
    ...
    const setList2 = await updateAccessSql.setList(newList)
    expect(setList2.success).toBe(true)


    const getAll3 = await updateAccessSql.getAll()
