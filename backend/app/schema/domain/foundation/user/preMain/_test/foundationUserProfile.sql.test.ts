...
describe("test foundationUserProfile.sql.js", () => {
  ...
  test("upsertOne: foundationUserProfile can add record.", async () => {
    ...
    const newUserProfile = await userProfileSql.upsertOne({
      id:  uuidv4(),
      firstName: "John",
      lastName: "Doe",
  ...
  test("getOne: foundationUserProfiles can add record.", async () => {
    ...
    const getUserProfile = await userProfileSql.getOneById({
      id: recordId,
    })
  ...
  test("updateOne: foundationUserProfiles can update record.", async () => {
    ...
    const updateUserProfile = await userProfileSql.upsertOne({
      id:  recordId,
      labelColor: "blue"
    })
